...
const basePath = '/cnno-1775462172213';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Our signature OG Rolls are carefully crafted with a blend of traditional and modern techniques, featuring a sweet and sticky swirl that will satisfy your cravings. Made with the finest ingredients, these rolls are a classic treat that never goes out of style.', i: 'https://images.unsplash.com/photo-1607958996333-0a99b2d1c339?w=1200&q=80', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'For those looking for a nutty twist, our Pistachio Rolls offer a delightful combination of flavors and textures, with a generous helping of pistachios adding a satisfying crunch to our signature cinnamon roll recipe.', i: 'https://images.unsplash.com/photo-1606101273945-3b5e34cd10a9?w=1200&q=80', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Indulge in the richness of our Chocolate Rolls, where decadent chocolate meets the warmth of cinnamon, creating a truly irresistible treat that will leave you wanting more.', i: 'https://images.unsplash.com/photo-1574085733277-851d9d856a3a?w=1200&q=80', icon: 'chair' }, { n: 'Baby Rolls', d: 'Perfect for snacking on-the-go, our Baby Rolls are bite-sized versions of our signature cinnamon rolls, packed with the same love and care as our larger rolls, but in a smaller, more convenient package.', i: 'https://images.unsplash.com/photo-1517433670165-51e2c0e8e72c?w=1200&q=80', icon: 'eco' }, { n: 'Party Box', d: 'Whether you\'re hosting a party or just want to share the love, our Party Box is the perfect solution, featuring a selection of our finest rolls in a beautifully presented box that\'s sure to impress your friends and family.', i: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc7a?w=1200&q=80', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1499636757265-e4040923efd0?w=1200&q=80" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft high-quality, artisanal cinnamon rolls that bring warmth and comfort to our customers, while fostering a sense of community through our passion for baking.</p>
                </div>
                <div className="space-y-2">
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.unsplash.com/photo-1578985545062-a3b02dc3e4e1?w=1200&q=80" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.unsplash.com/photo-1486427944299-d1955d23e34d?w=1200&q=80" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.unsplash.com/photo-1509440159596-0249088772ff?w=1200&q=80" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
